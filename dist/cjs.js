 ...
 */
var SIZES$1 = {
    sm: Ae(templateObject_1$1 || (templateObject_1$1 = __makeTemplateObject(["\n        --text-font-size: 10px;\n    "], ["\n        --text-font-size: 10px;\n    "]))),
    md: Ae(templateObject_2$1 || (templateObject_2$1 = __makeTemplateObject(["\n        --text-font-size: 14px;\n    "], ["\n        --text-font-size: 14px;\n    "]))),
    lg: Ae(templateObject_3$1 || (templateObject_3$1 = __makeTemplateObject(["\n        --text-font-size: 18px;\n    "], ["\n        --text-font-size: 18px;\n    "]))),
};
var StyledText = qe.span(templateObject_4$1 || (templateObject_4$1 = __makeTemplateObject(["\n    ", "\n    font-size: var(--text-font-size, 14px);\n    color: ", ";\n"], ["\n    ", "\n    font-size: var(--text-font-size, 14px);\n    color: ", ";\n"])), function (_a) {
    var size = _a.size;
    return SIZES$1[size];
}, function (props) { return props.color || "rgba(0, 0, 0, 1)"; });
var Text = function (props) {
    var children = props.children, size = props.size, color = props.color;
    return (r__default["default"].createElement(StyledText, { size: size || "md", color: color }, children));
};
 ...
 */
var SIZES = {
    sm: Ae(templateObject_1 || (templateObject_1 = __makeTemplateObject(["\n        --button-font-size: 12px;\n        --button-padding: 6px 12px;\n    "], ["\n        --button-font-size: 12px;\n        --button-padding: 6px 12px;\n    "]))),
    md: Ae(templateObject_2 || (templateObject_2 = __makeTemplateObject(["\n        --button-font-size: 14px;\n        --button-padding: 8px 16px;\n    "], ["\n        --button-font-size: 14px;\n        --button-padding: 8px 16px;\n    "]))),
    lg: Ae(templateObject_3 || (templateObject_3 = __makeTemplateObject(["\n        --button-font-size: 16px;\n        --button-padding: 10px 20px;\n    "], ["\n        --button-font-size: 16px;\n        --button-padding: 10px 20px;\n    "]))),
};
var VARIANTS = {
    solid: Ae(templateObject_4 || (templateObject_4 = __makeTemplateObject(["\n        --button-color: #fafafa;\n        --button-bg-color: #0f7acb;\n        --button-hover-bg-color: #28acfc;\n    "], ["\n        --button-color: #fafafa;\n        --button-bg-color: #0f7acb;\n        --button-hover-bg-color: #28acfc;\n    "]))),
    outline: Ae(templateObject_5 || (templateObject_5 = __makeTemplateObject(["\n        --button-color: #0f7acb;\n        --button-bg-color: transparent;\n        --button-border: 1px solid #9da2a6;\n        --button-hover-color: #0f7acb;\n        --button-hover-bg-color: #28acfc1a;\n    "], ["\n        --button-color: #0f7acb;\n        --button-bg-color: transparent;\n        --button-border: 1px solid #9da2a6;\n        --button-hover-color: #0f7acb;\n        --button-hover-bg-color: #28acfc1a;\n    "]))),
    ghost: Ae(templateObject_6 || (templateObject_6 = __makeTemplateObject(["\n        --button-color: #0f7acb;\n        --button-bg-color: transparent;\n        --button-hover-color: #28acfc;\n        --button-hover-bg-color: transparent;\n    "], ["\n        --button-color: #0f7acb;\n        --button-bg-color: transparent;\n        --button-hover-color: #28acfc;\n        --button-hover-bg-color: transparent;\n    "]))),
};
var COLOR_SOLID = {
    blue: Ae(templateObject_7 || (templateObject_7 = __makeTemplateObject(["\n        --button-color: #fafafa;\n        --button-bg-color: #0f7acb;\n        --button-hover-bg-color: #28acfc;\n    "], ["\n        --button-color: #fafafa;\n        --button-bg-color: #0f7acb;\n        --button-hover-bg-color: #28acfc;\n    "]))),
    green: Ae(templateObject_8 || (templateObject_8 = __makeTemplateObject(["\n        --button-color: #fafafa;\n        --button-bg-color: #00725b;\n        --button-hover-bg-color: #00b38c;\n    "], ["\n        --button-color: #fafafa;\n        --button-bg-color: #00725b;\n        --button-hover-bg-color: #00b38c;\n    "]))),
    red: Ae(templateObject_9 || (templateObject_9 = __makeTemplateObject(["\n        --button-color: #fafafa;\n        --button-bg-color: #fd4547;\n        --button-hover-bg-color: #ff8b8d;\n    "], ["\n        --button-color: #fafafa;\n        --button-bg-color: #fd4547;\n        --button-hover-bg-color: #ff8b8d;\n    "]))),
    gray: Ae(templateObject_10 || (templateObject_10 = __makeTemplateObject(["\n        --button-color: #fafafa;\n        --button-bg-color: #4a4f54;\n        --button-hover-bg-color: #61666b;\n    "], ["\n        --button-color: #fafafa;\n        --button-bg-color: #4a4f54;\n        --button-hover-bg-color: #61666b;\n    "]))),
};
var COLOR_OUTLINE = {
    blue: Ae(templateObject_11 || (templateObject_11 = __makeTemplateObject(["\n        --button-color: #0f7acb;\n        --button-hover-color: #0f7acb;\n        --button-hover-bg-color: #28acfc1a;\n    "], ["\n        --button-color: #0f7acb;\n        --button-hover-color: #0f7acb;\n        --button-hover-bg-color: #28acfc1a;\n    "]))),
    green: Ae(templateObject_12 || (templateObject_12 = __makeTemplateObject(["\n        --button-color: #00725b;\n        --button-hover-color: #00725b;\n        --button-hover-bg-color: #00b38c1a;\n    "], ["\n        --button-color: #00725b;\n        --button-hover-color: #00725b;\n        --button-hover-bg-color: #00b38c1a;\n    "]))),
    red: Ae(templateObject_13 || (templateObject_13 = __makeTemplateObject(["\n        --button-color: #fd4547;\n        --button-hover-color: #fd4547;\n        --button-hover-bg-color: #ff8b8d1a;\n    "], ["\n        --button-color: #fd4547;\n        --button-hover-color: #fd4547;\n        --button-hover-bg-color: #ff8b8d1a;\n    "]))),
    gray: Ae(templateObject_14 || (templateObject_14 = __makeTemplateObject(["\n        --button-color: #4a4f54;\n        --button-hover-color: #4a4f54;\n        --button-hover-bg-color: #61666b1a;\n    "], ["\n        --button-color: #4a4f54;\n        --button-hover-color: #4a4f54;\n        --button-hover-bg-color: #61666b1a;\n    "]))),
};
var COLOR_GHOST = {
    blue: Ae(templateObject_15 || (templateObject_15 = __makeTemplateObject(["\n        --button-color: #0f7acb;\n        --button-hover-color: #28acfc;\n    "], ["\n        --button-color: #0f7acb;\n        --button-hover-color: #28acfc;\n    "]))),
    green: Ae(templateObject_16 || (templateObject_16 = __makeTemplateObject(["\n        --button-color: #00725b;\n        --button-hover-color: #00b38c;\n    "], ["\n        --button-color: #00725b;\n        --button-hover-color: #00b38c;\n    "]))),
    red: Ae(templateObject_17 || (templateObject_17 = __makeTemplateObject(["\n        --button-color: #fd4547;\n        --button-hover-color: #ff8b8d;\n    "], ["\n        --button-color: #fd4547;\n        --button-hover-color: #ff8b8d;\n    "]))),
    gray: Ae(templateObject_18 || (templateObject_18 = __makeTemplateObject(["\n        --button-color: #4a4f54;\n        --button-hover-color: #61666b;\n    "], ["\n        --button-color: #4a4f54;\n        --button-hover-color: #61666b;\n    "]))),
};
var StyledButton = qe.button(templateObject_19 || (templateObject_19 = __makeTemplateObject(["\n    ", "\n    ", "\n    ", "\n    ", "\n    ", "\n\n    display: inline-block;\n    box-sizing: border-box;\n    text-align: center;\n    text-decoration: none;\n    vertical-align: middle;\n    position: relative;\n    border-radius: 0;\n    min-width: 60px;\n    margin: 4px;\n    cursor: pointer;\n    font-size: var(--button-font-size, 14px);\n    padding: var(--button-padding, 12px 16px);\n    color: var(--button-color, #fafafa);\n    background: var(--button-bg-color, #0f7acb);\n    border: var(--button-border, none);\n\n    &:active,\n    &:hover,\n    &:focus {\n        color: var(--button-hover-color, #fafafa);\n        background: var(--button-hover-bg-color, #28acfc);\n    }\n\n    &:disabled {\n        opacity: 0.5;\n        pointer-events: none;\n    }\n"], ["\n    ", "\n    ", "\n    ", "\n    ", "\n    ", "\n\n    display: inline-block;\n    box-sizing: border-box;\n    text-align: center;\n    text-decoration: none;\n    vertical-align: middle;\n    position: relative;\n    border-radius: 0;\n    min-width: 60px;\n    margin: 4px;\n    cursor: pointer;\n    font-size: var(--button-font-size, 14px);\n    padding: var(--button-padding, 12px 16px);\n    color: var(--button-color, #fafafa);\n    background: var(--button-bg-color, #0f7acb);\n    border: var(--button-border, none);\n\n    &:active,\n    &:hover,\n    &:focus {\n        color: var(--button-hover-color, #fafafa);\n        background: var(--button-hover-bg-color, #28acfc);\n    }\n\n    &:disabled {\n        opacity: 0.5;\n        pointer-events: none;\n    }\n"])), function (_a) {
    var size = _a.size;
    return SIZES[size];
}, function (_a) {
    ...
    var variant = _a.variant, colorScheme = _a.colorScheme;
    return variant === "solid" && COLOR_SOLID[colorScheme];
}, function (_a) {
    var variant = _a.variant, colorScheme = _a.colorScheme;
    return variant === "outline" && COLOR_OUTLINE[colorScheme];
}, function (_a) {
    var variant = _a.variant, colorScheme = _a.colorScheme;
    return variant === "ghost" && COLOR_GHOST[colorScheme];
});
var Button = function (props) {
    var children = props.children, disabled = props.disabled, type = props.type, onClick = props.onClick, variant = props.variant, colorScheme = props.colorScheme, size = props.size;
    return (r__default["default"].createElement(StyledButton, { disabled: disabled || false, type: type || "button", onClick: onClick && (function () { return onClick(); }), size: size || "md", variant: variant || "solid", colorScheme: colorScheme || "blue" }, children));
};
