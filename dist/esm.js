...
var Text = function (props) {
    ...
    return (r.createElement(StyledText, { size: size || "md", color: color }, children));
};
...
var Button = function (props) {
    ...
    return (r.createElement(StyledButton, { disabled: disabled || false, type: type || "button", onClick: onClick && (function () { return onClick(); }), size: size || "md", variant: variant || "solid", colorScheme: colorScheme || "blue" }, children));
};
